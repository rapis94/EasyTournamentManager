...
try {
    ...
    if ($result) {
        $to = $_POST["email"];
        $subject = "Bienvenido a la nueva plataforma de Monoz. Instrucciones de como seguir";
        ...
        $headers .= 'From: contacto@vanillasoftworks.com' . "\r\n";
        mail($to, $subject, $message, $headers);
        echo json_encode(["codigo" => "200", "mensaje" => "Gracias por tu registro!. Espera a recibir el E-Mail de confirmación para poder definir tu contraseña."]);
    } else {
        echo json_encode(["codigo" => "500", "mensaje" => "Hubo un error interno al intentar registrarte, por favor, comunícate al mail llc94@hotmail.es para informar el problema"]);
    }
