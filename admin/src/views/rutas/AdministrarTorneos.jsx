...
import CrearTorneo from "../../componentes/forms/torneos/CrearTorneo";
...
export default function AdministrarTorneos() {
    ...
    const crearTorneo = () => {
        setModal(<BasicModal titulo="Crear nuevo torneo" onClose={() => setModal(null)} contenido={<CrearTorneo callback={torneoCreado}></CrearTorneo>}></BasicModal>)
    }
    ...
    return (
        <div className="aparecer">
            ...
            <button onClick={crearTorneo} className="btn btn-primary mb-3">Crear nuevo torneo</button>
            {modal}
