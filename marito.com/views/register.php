...
<form class="form" onsubmit="enviarRegistro(event, this)">
    ...
    <div class="form-control-custom">
        <label for="steam" style="width: 100%; display: flex; justify-content: space-between">
            <b>Link de Steam *</b>
            <div onclick="showHideItem(document.getElementById('donde'))" style="color: white; text-decoration: underline; cursor: pointer">
                 ¿Donde lo encuentro? <i class="bi bi-question-circle-fill" style="color: white"></i>
            </div>
        </label>
