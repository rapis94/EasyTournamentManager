...
import SinFoto from "../../assets/sinfoto.png";
    ...
    <div className="form-group position-relative">
      ...
      {accept == "image/*" && (
        <div style={{ width: "100%", textAlign: "center" }}>
          <img src={image ? image : previous ? previous : SinFoto} width={96} height={96} style={{ objectFit: "contain", objectPosition: "center" }}></img>
        </div>
      )}
